"""Empire Academy course crawl v3 — 24fps WITH MOTION BLUR.
...
BLUR_SAMPLES = 5
BLUR_OFFSETS = np.linspace(-1.5, 1.5, BLUR_SAMPLES)

FFMPEG = r"C:\Program Files\Shotcut\ffmpeg.exe"
OUT = r"C:\ai\ComfyUI\output\empire_academy_crawl_v3_motionblur.mp4"
TMP = tempfile.mkdtemp(prefix="empmb_")
...
LINES = [
    ...
    ("",                                  "spacer"),
    ("Blaster Repair",                    "body"),
    ("and Recoil Physics",                "body"),
    ("",                                  "spacer"),
    ("Rankor Negotiation",                "body"),
    ("",                                  "spacer"),
    ("Trash Compactor Ethics",            "body"),
    ("",                                  "spacer"),
    ("Jedi Mind Trick",                   "body"),
    ("Defense Tactics",                   "body"),
    ("",                                  "spacer"),
    ("Droid Interrogation 101",           "emphasis"),
    ("",                                  "spacer"),
    ("Thermal Exhaust",                   "body"),
    ("Shield Theory",                     "body"),
    ("",                                  "spacer"),
    ("Imperial Paperwork Avoidance",      "body"),
    ("",                                  "spacer"),
    ("Death Star Ergonomics",             "body"),
    ("",                                  "spacer"),
    ("AND MANY MANY MORE...",             "emphasis"),
]
...
SCROLL_PER_FRAME = SCROLL_SPEED / FPS
...
print(f"  Rendering {TOTAL_FRAMES} frames x {BLUR_SAMPLES} samples...")
