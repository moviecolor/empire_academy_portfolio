"""Empire Academy course crawl v2 — 60fps for smooth scrolling.
...
OUT = r"C:\ai\ComfyUI\output\empire_academy_crawl_v2_60fps.mp4"
TMP = tempfile.mkdtemp(prefix="empire_")
...
print(f"      Empire Academy Course Catalog")
